  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use User.conf.findById() instead.
        "prototype$__findById__conf": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/users/:id/conf/:fk",
          method: "GET"
        },

        // INTERNAL. Use User.conf.destroyById() instead.
        "prototype$__destroyById__conf": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/users/:id/conf/:fk",
        ...
        // INTERNAL. Use User.conf.updateById() instead.
        "prototype$__updateById__conf": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/users/:id/conf/:fk",
        ...
        // INTERNAL. Use User.conf.link() instead.
        "prototype$__link__conf": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/users/:id/conf/rel/:fk",
          method: "PUT"
        },

        // INTERNAL. Use User.conf.unlink() instead.
        "prototype$__unlink__conf": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/users/:id/conf/rel/:fk",
        ...
        // INTERNAL. Use User.conf.exists() instead.
        "prototype$__exists__conf": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/users/:id/conf/rel/:fk",
        ...
        // INTERNAL. Use User.conf() instead.
        "prototype$__get__conf": {
          isArray: true,
          url: urlBase + "/users/:id/conf",
          method: "GET"
        },

        // INTERNAL. Use User.conf.create() instead.
        "prototype$__create__conf": {
          url: urlBase + "/users/:id/conf",
          method: "POST"
        },

        // INTERNAL. Use User.conf.destroyAll() instead.
        "prototype$__delete__conf": {
          url: urlBase + "/users/:id/conf",
          method: "DELETE"
        },

        // INTERNAL. Use User.conf.count() instead.
        "prototype$__count__conf": {
          url: urlBase + "/users/:id/conf/count",
          method: "GET"
        },
        ...
        /**
         * @ngdoc method
         * @name lbServices.User#fileScript
         * @methodOf lbServices.User
         *
         * @description
         *
        ...
        // INTERNAL. Use User_conf.user() instead.
        "::get::user_conf::user": {
          url: urlBase + "/user_confs/:id/user",
          method: "GET"
        },

        // INTERNAL. Use Conf.users.findById() instead.
        "::findById::conf::users": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/confs/:id/users/:fk",
          method: "GET"
        },

        // INTERNAL. Use Conf.users.destroyById() instead.
        "::destroyById::conf::users": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/confs/:id/users/:fk",
        ...
        // INTERNAL. Use Conf.users.updateById() instead.
        "::updateById::conf::users": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/confs/:id/users/:fk",
        ...
        // INTERNAL. Use Conf.users.link() instead.
        "::link::conf::users": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/confs/:id/users/rel/:fk",
          method: "PUT"
        },

        // INTERNAL. Use Conf.users.unlink() instead.
        "::unlink::conf::users": {
          params: {
          'fk': '@fk'
          },
        ...
        // INTERNAL. Use Conf.users.exists() instead.
        "::exists::conf::users": {
          params: {
          'fk': '@fk'
          },
        ...
        // INTERNAL. Use Conf.users() instead.
        "::get::conf::users": {
          isArray: true,
          url: urlBase + "/confs/:id/users",
          method: "GET"
        },

        // INTERNAL. Use Conf.users.create() instead.
        "::create::conf::users": {
          url: urlBase + "/confs/:id/users",
          method: "POST"
        },

        // INTERNAL. Use Conf.users.createMany() instead.
        "::createMany::conf::users": {
          isArray: true,
          url: urlBase + "/confs/:id/users",
          method: "POST"
        },

        // INTERNAL. Use Conf.users.destroyAll() instead.
        "::delete::conf::users": {
          url: urlBase + "/confs/:id/users",
          method: "DELETE"
        },

        // INTERNAL. Use Conf.users.count() instead.
        "::count::conf::users": {
          url: urlBase + "/confs/:id/users/count",
          method: "GET"
        },
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.User.conf
     * @header lbServices.User.conf
     * @object
     * @description
     *
     * The object `User.conf` groups methods
     * manipulating `Conf` instances related to `User`.
     *
     * Call {@link lbServices.User#conf User.conf()}
     * to query all related instances.
     */
         ...
         */
        R.conf = function() {
          var TargetResource = $injector.get("Conf");
          var action = TargetResource["::get::user::conf"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.conf#count
         * @methodOf lbServices.User.conf
         *
         * @description
         *
         * Counts conf of user.
         ...
         *  - `count` – `{number=}` - 
         */
        R.conf.count = function() {
          var TargetResource = $injector.get("Conf");
          var action = TargetResource["::count::user::conf"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.conf#create
         * @methodOf lbServices.User.conf
         *
         * @description
         *
         * Creates a new instance in conf of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * </em>
         */
        R.conf.create = function() {
          var TargetResource = $injector.get("Conf");
          var action = TargetResource["::create::user::conf"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.conf#createMany
         * @methodOf lbServices.User.conf
         *
         * @description
         *
         ...
         * </em>
         */
        R.conf.createMany = function() {
          var TargetResource = $injector.get("Conf");
          var action = TargetResource["::createMany::user::conf"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.conf#destroyAll
         * @methodOf lbServices.User.conf
         *
         * @description
         *
         * Deletes all conf of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * This method returns no data.
         */
        R.conf.destroyAll = function() {
          var TargetResource = $injector.get("Conf");
          var action = TargetResource["::delete::user::conf"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.conf#destroyById
         * @methodOf lbServices.User.conf
         *
         * @description
         *
         * Delete a related item by id for conf.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         *
         *  - `fk` – `{*}` - Foreign key for conf
         *
         * @param {function(Object,Object)=} successCb
         *   Success callback with two arguments: `value`, `responseHeaders`.
         *
         ...
         * This method returns no data.
         */
        R.conf.destroyById = function() {
          var TargetResource = $injector.get("Conf");
          var action = TargetResource["::destroyById::user::conf"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.conf#exists
         * @methodOf lbServices.User.conf
         *
         * @description
         *
         * Check the existence of conf relation to an item by id.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * </em>
         */
        R.conf.exists = function() {
          var TargetResource = $injector.get("Conf");
          var action = TargetResource["::exists::user::conf"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.conf#findById
         * @methodOf lbServices.User.conf
         *
         * @description
         *
         * Find a related item by id for conf.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * </em>
         */
        R.conf.findById = function() {
          var TargetResource = $injector.get("Conf");
          var action = TargetResource["::findById::user::conf"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.conf#link
         * @methodOf lbServices.User.conf
         *
         * @description
         *
         * Add a related item by id for conf.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * </em>
         */
        R.conf.link = function() {
          var TargetResource = $injector.get("Conf");
          var action = TargetResource["::link::user::conf"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.conf#unlink
         * @methodOf lbServices.User.conf
         *
         * @description
         *
         * Remove the conf relation to an item by id.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * This method returns no data.
         */
        R.conf.unlink = function() {
          var TargetResource = $injector.get("Conf");
          var action = TargetResource["::unlink::user::conf"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.conf#updateById
         * @methodOf lbServices.User.conf
         *
         * @description
         *
         * Update a related item by id for conf.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * </em>
         */
        R.conf.updateById = function() {
          var TargetResource = $injector.get("Conf");
          var action = TargetResource["::updateById::user::conf"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Fbapp#createMany
         * @methodOf lbServices.Fbapp
         *
         * @description
         *
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Visitor.chats.findById() instead.
        "prototype$__findById__chats": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/visitors/:id/chats/:fk",
          method: "GET"
        },

        // INTERNAL. Use Visitor.chats.destroyById() instead.
        ...
        // INTERNAL. Use Visitor.chats.updateById() instead.
        ...
        // INTERNAL. Use Visitor.chats() instead.
        "prototype$__get__chats": {
          isArray: true,
          url: urlBase + "/visitors/:id/chats",
          method: "GET"
        },

        // INTERNAL. Use Visitor.chats.create() instead.
        "prototype$__create__chats": {
          url: urlBase + "/visitors/:id/chats",
          method: "POST"
        },

        // INTERNAL. Use Visitor.chats.destroyAll() instead.
        "prototype$__delete__chats": {
          url: urlBase + "/visitors/:id/chats",
          method: "DELETE"
        },

        // INTERNAL. Use Visitor.chats.count() instead.
        "prototype$__count__chats": {
          url: urlBase + "/visitors/:id/chats/count",
          method: "GET"
        },
        ...
        /**
         * @ngdoc method
         * @name lbServices.Visitor#prototype$updateAttributes
         * @methodOf lbServices.Visitor
         *
         * @description
         *
        ...
        // INTERNAL. Use Chat.visitor() instead.
        "::get::chat::visitor": {
          url: urlBase + "/chats/:id/visitor",
          method: "GET"
        },
      }
    );
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Visitor.chats
     * @header lbServices.Visitor.chats
     * @object
     * @description
     *
     * The object `Visitor.chats` groups methods
     * manipulating `Chat` instances related to `Visitor`.
     *
     * Call {@link lbServices.Visitor#chats Visitor.chats()}
     * to query all related instances.
     */
        ...
        R.chats = function() {
          ...
          var action = TargetResource["::get::visitor::chats"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Visitor.chats#count
         * @methodOf lbServices.Visitor.chats
         *
         * @description
         *
         * Counts chats of visitor.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.chats.count = function() {
          var TargetResource = $injector.get("Chat");
          var action = TargetResource["::count::visitor::chats"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Visitor.chats#create
         * @methodOf lbServices.Visitor.chats
         *
         * @description
         *
        ...
        R.chats.create = function() {
          var TargetResource = $injector.get("Chat");
          var action = TargetResource["::create::visitor::chats"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Visitor.chats#createMany
         * @methodOf lbServices.Visitor.chats
         *
         * @description
         *
        ...
        R.chats.createMany = function() {
          var TargetResource = $injector.get("Chat");
          var action = TargetResource["::createMany::visitor::chats"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Visitor.chats#destroyAll
         * @methodOf lbServices.Visitor.chats
         *
         * @description
         *
        ...
        R.chats.destroyAll = function() {
          var TargetResource = $injector.get("Chat");
          var action = TargetResource["::delete::visitor::chats"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Visitor.chats#destroyById
         * @methodOf lbServices.Visitor.chats
         *
         * @description
         *
        ...
        R.chats.destroyById = function() {
          var TargetResource = $injector.get("Chat");
          var action = TargetResource["::destroyById::visitor::chats"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Visitor.chats#findById
         * @methodOf lbServices.Visitor.chats
         *
         * @description
         *
        ...
        R.chats.findById = function() {
          var TargetResource = $injector.get("Chat");
          var action = TargetResource["::findById::visitor::chats"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Visitor.chats#updateById
         * @methodOf lbServices.Visitor.chats
         *
         * @description
         *
        ...
        R.chats.updateById = function() {
          var TargetResource = $injector.get("Chat");
          var action = TargetResource["::updateById::visitor::chats"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Visitor.chats.create() instead.
        "::create::visitor::chats": {
          url: urlBase + "/visitors/:id/chats",
          method: "POST"
        },

        // INTERNAL. Use Visitor.chats.createMany() instead.
        "::createMany::visitor::chats": {
          isArray: true,
          url: urlBase + "/visitors/:id/chats",
          method: "POST"
        },
    ...
    */
    R.modelName = "Chat";
        ...
        /**
         * @ngdoc method
         * @name lbServices.Chat#visitor
         * @methodOf lbServices.Chat
         *
         * @description
         *
         * Fetches belongsTo relation visitor.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         */
        R.visitor = function() {
          var TargetResource = $injector.get("Visitor");
          var action = TargetResource["::get::chat::visitor"];
          return action.apply(R, arguments);
        };
...
/**
 * @ngdoc object
 * @name lbServices.User_conf
 * @header lbServices.User_conf
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `User_conf` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use User_conf.conf() instead.
        "prototype$__get__conf": {
          url: urlBase + "/user_confs/:id/conf",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.User_conf#create
         * @methodOf lbServices.User_conf
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `User_conf` object.)
         * </em>
         */
        "create": {
          url: urlBase + "/user_confs",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.User_conf#createMany
         * @methodOf lbServices.User_conf
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.User_conf#upsert
         * @methodOf lbServices.User_conf
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.User_conf#exists
         * @methodOf lbServices.User_conf
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/user_confs/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.User_conf#findById
         * @methodOf lbServices.User_conf
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/user_confs/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.User_conf#find
         * @methodOf lbServices.User_conf
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.User_conf#findOne
         * @methodOf lbServices.User_conf
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/user_confs/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.User_conf#updateAll
         * @methodOf lbServices.User_conf
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/user_confs/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.User_conf#deleteById
         * @methodOf lbServices.User_conf
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.User_conf#count
         * @methodOf lbServices.User_conf
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/user_confs/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.User_conf#prototype$updateAttributes
         * @methodOf lbServices.User_conf
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.User_conf#updateOrCreate
         * @methodOf lbServices.User_conf
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.User_conf#update
         * @methodOf lbServices.User_conf
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.User_conf#destroyById
         * @methodOf lbServices.User_conf
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.User_conf#removeById
         * @methodOf lbServices.User_conf
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.User_conf#modelName
    * @propertyOf lbServices.User_conf
    * @description
    * The name of the model represented by this $resource,
    * i.e. `User_conf`.
    */
    R.modelName = "User_conf";


        /**
         * @ngdoc method
         * @name lbServices.User_conf#user
         * @methodOf lbServices.User_conf
         *
         * @description
         *
        ...
        R.user = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::get::user_conf::user"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User_conf#conf
         * @methodOf lbServices.User_conf
         *
         * @description
         *
         * Fetches belongsTo relation conf.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.conf = function() {
          var TargetResource = $injector.get("Conf");
          var action = TargetResource["::get::user_conf::conf"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use User.conf.createMany() instead.
        "::createMany::user::conf": {
          isArray: true,
          url: urlBase + "/users/:id/conf",
          method: "POST"
        },
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Conf.users
     * @header lbServices.Conf.users
     * @object
     * @description
     *
     * The object `Conf.users` groups methods
     * manipulating `User` instances related to `Conf`.
     *
     * Call {@link lbServices.Conf#users Conf.users()}
     * to query all related instances.
     */
        ...
        R.users = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::get::conf::users"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Conf.users#count
         * @methodOf lbServices.Conf.users
         *
         * @description
         *
         * Counts users of conf.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.users.count = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::count::conf::users"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Conf.users#create
         * @methodOf lbServices.Conf.users
         *
         * @description
         *
        ...
        R.users.create = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::create::conf::users"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Conf.users#createMany
         * @methodOf lbServices.Conf.users
         *
         * @description
         *
        ...
        R.users.createMany = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::createMany::conf::users"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Conf.users#destroyAll
         * @methodOf lbServices.Conf.users
         *
         * @description
         *
        ...
        R.users.destroyAll = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::delete::conf::users"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Conf.users#destroyById
         * @methodOf lbServices.Conf.users
         *
         * @description
         *
        ...
        R.users.destroyById = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::destroyById::conf::users"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Conf.users#exists
         * @methodOf lbServices.Conf.users
         *
         * @description
         *
        ...
        R.users.exists = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::exists::conf::users"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Conf.users#findById
         * @methodOf lbServices.Conf.users
         *
         * @description
         *
        ...
        R.users.findById = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::findById::conf::users"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Conf.users#link
         * @methodOf lbServices.Conf.users
         *
         * @description
         *
        ...
        R.users.link = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::link::conf::users"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Conf.users#unlink
         * @methodOf lbServices.Conf.users
         *
         * @description
         *
        ...
        R.users.unlink = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::unlink::conf::users"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Conf.users#updateById
         * @methodOf lbServices.Conf.users
         *
         * @description
         *
        ...
        R.users.updateById = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::updateById::conf::users"];
          return action.apply(R, arguments);
        };
...
/**
 * @ngdoc object
 * @name lbServices.Kourier
 * @header lbServices.Kourier
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Kourier` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Kourier#mlistCreate
         * @methodOf lbServices.Kourier
         *
         * @description
         *
         * <em>
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `Kourier` object.)
         * </em>
         */
        "mlistCreate": {
          url: urlBase + "/kouriers/mlistCreate",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Kourier#subscribe
         * @methodOf lbServices.Kourier
         *
         * @description
         *
         ...
         */
        "subscribe": {
          url: urlBase + "/kouriers/subscribe",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Kourier#fileUpload
         * @methodOf lbServices.Kourier
         *
         * @description
         *
         ...
         */
        "fileUpload": {
          url: urlBase + "/kouriers/fileUpload",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Kourier#query
         * @methodOf lbServices.Kourier
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.Kourier#modelName
    * @propertyOf lbServices.Kourier
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Kourier`.
    */
